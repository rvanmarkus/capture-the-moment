/**
 * @ngdoc controller
 * @name captureTheMomentApp.controller:AppController
 * @description
 * This is the application wide controller of the captureTheMomentApp application
 */
...
(function () {
	 ...
	 * @description
	 * Provider of the {@link captureTheMomentApp.controller:AppController AppController}
	 *
	...
	function AppController(Auth, $mdSidenav) {
		 ...
		 * @ngdoc function
		 * @name logout
		 * @methodOf captureTheMomentApp.controller:AppController
		 * @description
