/**
 * @ngdoc overview
 * @name captureTheMomentApp.admin.user.create
 * @description
 * The `captureTheMomentApp.admin.user.create` module which provides
 *
 * - {@link captureTheMomentApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
