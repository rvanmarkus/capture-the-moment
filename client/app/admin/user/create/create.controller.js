/**
 * @ngdoc controller
 * @name captureTheMomentApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('captureTheMomentApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name captureTheMomentApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link captureTheMomentApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link captureTheMomentApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf captureTheMomentApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf captureTheMomentApp.admin.user.create.controller:UserCreateController
		 * @description
