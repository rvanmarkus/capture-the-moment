/**
 * @ngdoc overview
 * @name captureTheMomentApp.admin.user.list.detail
 * @description
 * The `captureTheMomentApp.admin.user.list.detail` module which provides:
 *
 * - {@link captureTheMomentApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires captureTheMomentApp.auth.user
 */
(function () {
	'use strict';
