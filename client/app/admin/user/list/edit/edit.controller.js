/**
 * @ngdoc controller
 * @name captureTheMomentApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name captureTheMomentApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link captureTheMomentApp.admin.user.list.edit.controller:UserEditController UserEditController}
