/**
 * @ngdoc controller
 * @name captureTheMomentApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name captureTheMomentApp.admin.user.list.items.provider:UserItemsController
	 * @description
	 * Provider of the {@link captureTheMomentApp.admin.user.list.items.controller:UserItemsController UserItemsController}
	 *
	 */
	...
	function UserItemsController($state, Auth) {
		 ...
		 * @ngdoc function
		 * @name isSelected
		 * @methodOf captureTheMomentApp.admin.user.list.items.controller:UserItemsController
		 * @description
